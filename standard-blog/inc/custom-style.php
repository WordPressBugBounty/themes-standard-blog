 ...
 * Custom Style
 */
function standard_blog_header_text_style() {

	$site_title_font       = get_theme_mod( 'standard_blog_site_title_font', '' );
	$site_description_font = get_theme_mod( 'standard_blog_site_description_font', '' );
	$header_font           = get_theme_mod( 'standard_blog_header_font', '' );
	$body_font             = get_theme_mod( 'standard_blog_body_font', '' );
	...
	<style type="text/css">
		...
		.site-description {
			color: <?php echo esc_attr( get_theme_mod( 'standard_blog_header_tagline', '#222222' ) ); ?>;
		}
...
add_action( 'wp_head', 'standard_blog_header_text_style' );
