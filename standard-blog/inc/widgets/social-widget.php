<?php
if ( ! class_exists( 'Standard_Blog_Social_Widget' ) ) {
	/**
	 * Adds Standard Blog Social Widget.
	 */
	class Standard_Blog_Social_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$standard_blog_social_widget = array(
				'classname'   => 'widget adore-widget social-widget style-1',
				'description' => __( 'Retrive Social Widget', 'standard-blog' ),
			);
			parent::__construct(
				'standard_blog_social_widget',
				__( 'Adore Widget: Social Widget', 'standard-blog' ),
				$standard_blog_social_widget
			);
		}
