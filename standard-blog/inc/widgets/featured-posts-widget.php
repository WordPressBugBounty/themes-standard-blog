<?php
if ( ! class_exists( 'Standard_Blog_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Standard Blog Featured Posts Widget.
	 */
	class Standard_Blog_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				...
				'description' => __( 'Retrive Posts List Widgets', 'standard-blog' ),
			);
			parent::__construct(
				'standard_blog_featured_posts_widget',
				__( 'Adore Widget: Featured Posts Widget', 'standard-blog' ),
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'standard-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'standard-blog' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = standard_blog_get_post_cat_choices();
